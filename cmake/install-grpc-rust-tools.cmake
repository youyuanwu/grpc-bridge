...
set(expected_versions
    "protoc=${PROTOC_VERSION}\nprotoc-gen-rust-grpc=${PROTOC_GEN_RUST_GRPC_VERSION}")
set(install_required TRUE)
if(EXISTS "${version_stamp}")
  file(READ "${version_stamp}" installed_versions)
  string(STRIP "${installed_versions}" installed_versions)
  if(installed_versions STREQUAL expected_versions)
...
function(download_and_extract name url sha256 executable)
  if(NOT install_required AND EXISTS "${executable}")
...
file(WRITE "${version_stamp}" "${expected_versions}\n")
